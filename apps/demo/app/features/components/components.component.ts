        ...
        @switch (activeSection()) {
          @case ('button') {
            <section class="mb-16 scroll-m-20">
              ...
              <h2 class="text-2xl font-semibold text-gray-900 mt-10 mb-4">Variants</h2>
              <p class="text-gray-600 my-4">Choose from different visual styles.</p>
              ...
              <h2 class="text-2xl font-semibold text-gray-900 mt-10 mb-4">Sizes</h2>
              <p class="text-gray-600 my-4">Choose from different button sizes.</p>
              ...
              <h2 class="text-2xl font-semibold text-gray-900 mt-10 mb-4">Rounded</h2>
              <p class="text-gray-600 my-4">Control the border radius.</p>
              <div class="flex items-center gap-3 my-4 flex-wrap">
              ...
              <h2 class="text-2xl font-semibold text-gray-900 mt-10 mb-4">States</h2>
              <div class="flex items-center gap-3 my-4 flex-wrap">
          ...
          @case ('tabs') {
            <section class="mb-16 scroll-m-20">
              ...
              <h2 class="text-2xl font-semibold text-gray-900 mt-10 mb-4">Usage</h2>
              <pre class="bg-gray-100 text-gray-900 p-5 rounded-lg overflow-x-auto text-sm leading-relaxed my-4"><code>&lt;app-tabs [defaultValue]="'tab1'"&gt;
  &lt;app-tabs-list&gt;
