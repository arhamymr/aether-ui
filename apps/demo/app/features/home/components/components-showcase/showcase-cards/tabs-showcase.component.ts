  ...
  template: `
    <app-card class="flex-1 flex flex-col h-full">
      <div class="mb-6">
        ...
        <p class="text-sm text-muted-foreground">Tab navigation for content organization</p>
      </div>
        <div class="flex-1 flex flex-col min-h-[150px]">
          <div class="flex border-b border-border mb-4">
            ...
            <button class="px-4 py-2.5 text-sm font-medium text-muted-foreground bg-transparent border-none border-b-2 border-transparent cursor-pointer transition-all hover:text-foreground">
              Security
            </button>
            <button class="px-4 py-2.5 text-sm font-medium text-muted-foreground bg-transparent border-none border-b-2 border-transparent cursor-pointer transition-all hover:text-foreground">
              Notifications
